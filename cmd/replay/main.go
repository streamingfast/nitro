...
func main() {
	...
	if lastBlockStateRoot != (common.Hash{}) {
		...
		newBlock, _, err = arbos.ProduceBlock(message.Message, message.DelayedMessagesRead, lastBlockHeader, statedb, chainContext, chainConfig, false, core.MessageReplayMode, nil)
		if err != nil {
			panic(err)
		}
	} else {
